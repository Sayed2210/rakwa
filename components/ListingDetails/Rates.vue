...
const deleteReview = async (id: number) => {
  ...
  ShowListingDetailsController.getInstance().showListingDetails(
      new ShowListingDetailsParams(useRoute().params.id!),
  );
};
...
<template>
  <section class="rate-wrapper">
    <div class="my-rate-wrapper">
      <div class="my-rate" v-for="myReview in myReviews"
           :key="myReview.id">
            ...
            <div class="flex">
              ...
              <div>
                ...
                <div class="rate-count flex gap-2">
                  <GlobalRate :rateCount="myReview.rate" />
          ...
          <div class="images">
            ...
            <Galleria v-model:activeIndex="activeIndex" v-model:visible="MyRateDisplayCustom" :value="myReview.images" :responsiveOptions="responsiveOptions" :numVisible="7"
    ...
    <div class="rates" v-for="rate in reviews" :key="rate.id">
      <div class="flex justify-between w-full">
        <div class="flex">
          ...
          <div>
            ...
            <div class="rate-count flex gap-2">
              <GlobalRate :rateCount="rate.rate" />
      ...
      <div class="images">
        ...
        <Galleria v-model:activeIndex="activeIndex" v-model:visible="RatesDisplayCustom" :value="rate.images" :responsiveOptions="responsiveOptions" :numVisible="7"
                  containerStyle="width: 80%; margin: auto auto" :circular="true" :fullScreen="true"  :showItemNavigators="true" :showThumbnails="false">
          <template #item="slotProps">
            <img :src="slotProps.item.image" :alt="slotProps.item.alt" style="max-width: 100%; display: block" />
          </template>
